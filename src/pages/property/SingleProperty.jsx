...
function SingleProperty() {
    ...
    return (
        <div className="bg-white dark:bg-gray-900">
            ...
            <div className="pt-6">
                <div className="max-w-screen-xl mx-auto px-4 pb-16 pt-10 sm:px-6 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    {/* Property Images */}
                    <div className="lg:col-span-2 lg:border-r lg:border-gray-200 dark:border-gray-700 lg:pr-8">
                        <div className="grid grid-cols-2 gap-4">
                            {
                                propertyData?.images?.map((value, index) => (
                                    <div className="overflow-hidden rounded-lg border dark:border-gray-800 group hover:scale-105 transform transition-all duration-300" key={index}>
                                        <img src={`${import.meta.env.VITE_APP_BASE_URI}${value}`} alt="Property" className="h-full w-full object-cover object-center" />
                                    </div>
                                ))
                            }
                        </div>
                    ...
                    <div className="mt-6 lg:mt-0">
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white capitalize">{propertyData?.name}</h1>
                        <p className="text-xl text-gray-900 dark:text-white mt-2">Rs. {propertyData?.price}</p>
                        ...
                        <div className="flex items-center gap-4 my-4">
                            ...
                            />
                            <span className="text-sm text-gray-500">{propertyData?.rating} out of 5 Stars</span>
                        </div>

                        {/* Add to Cart & Wishlist */}
                        <div className="flex flex-col gap-3">
                            <button
                                onClick={() => { isAuthenticated ? addToCart() : toast.error('Please Login First') }}
                                className="flex items-center justify-center gap-2 bg-green-600 text-white font-medium py-3 px-8 rounded-md hover:bg-green-700 focus:outline-none transition-all duration-300"
                            >
                                Add to Cart <FaShoppingCart size={18} />
                            </button>
                            <button
                                onClick={addToWishlist}
                                className="flex items-center justify-center gap-2 bg-transparent border-2 border-gray-300 text-gray-800 font-medium py-3 px-8 rounded-md hover:bg-gray-100 transition-all duration-300"
                            >
                        ...
                        <div className="mt-8">
                            ...
                            <p className="text-base text-gray-800 dark:text-gray-400 mt-2">{propertyData?.description}</p>
                        </div>
                    </div>
                </div>
                ...
                <section className="max-w-7xl mx-auto mt-16 p-4">
                        ...
                        {props => (
                            <Form className="mt-6">
                                ...
                                <Field
                                    name="message"
                                    as="textarea"
                                    className="w-full mt-4 p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                    placeholder="Write a Comment"
                                />
                                <button
                                    type="submit"
                                    className="mt-4 w-full bg-blue-600 text-white py-3 rounded-md hover:bg-blue-700 transition-all duration-300"
                                >
                                    Submit Review
                                </button>
                            </Form>
                    ...
                    <div className="mt-8">
                        {ratingData?.map((review, index) => (
                            <div className="flex items-center gap-4 my-6 p-4 border-b dark:border-gray-700" key={index}>
                                <div>
                                    <img
                                        src={review.user.image ? `${import.meta.env.VITE_APP_BASE_URI}${review.user.image}` : '/images/avatar.jpg'}
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 dark:text-gray-400 mt-2">{review?.message}</p>
                                </div>
                            </div>
                        ))}
                    </div>
